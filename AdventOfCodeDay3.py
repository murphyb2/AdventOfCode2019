...
def CreateLine(input):
  ...
  dwg = []
  # dwg.append((currentPos.X, currentPos.Y))  
...
def CrossedWiresPart1():
  ...
  for intersection in intersections:
    ...
    result = ManhattanDistance(intersection)
